...
<script RunAt="server">
    ...
    public static void RegisterRoutes(RouteCollection routes)
    {
        ...
        //DefaultModel.RegisterContext(typeof(RDSICA2DataContext), new ContextConfiguration() { ScaffoldAllTables = true });
        ...
        //routes.Add(new DynamicDataRoute("Tutorials/{action}.aspx")
        //{
